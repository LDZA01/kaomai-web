...
export const mockJobs: Job[] = [
  ...
  },
  {
    id: 'job-4',
    employerId: 'employer-1',
    title: 'พนักงานดูแลพื้นที่สำนักงาน',
    description: 'ดูแลความสะอาดพื้นที่ส่วนกลาง จัดเตรียมห้องประชุม และช่วยต้อนรับผู้มาติดต่อ',
    requiredSkills: ['ทำความสะอาด', 'บริการลูกค้า'],
    location: 'พญาไท',
    dailyWage: 560,
