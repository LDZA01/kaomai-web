...
import { Bell, BriefcaseBusiness, ChevronDown, ClipboardCheck, LayoutDashboard, LogOut, Menu, PlusCircle, Settings, UserRound, UsersRound, X } from 'lucide-react';
